...
y_train <- sim_data_train[,6]
y_test <- sim_data_test[,6]
...
#
# #
bart_mod <- bart(x_train = x_train,y_train = y_train,x_test = x_train,n_tree = 1,n_mcmc = 2000,n_burn = 250,n_min_size = 1,
     tau = 1,alpha = 0.95,beta = 2,df = 3,sigquant = 0.9,numcut = 100,scale_boolean = TRUE,K_bart = 2)

apgbart_bart_mod <- apgpbart::gp_bart(x_train = x_train,y = y_train,x_test = x_test,number_trees = 1,node_min_size = 1,
                                       burn = 500,bart_number_iter = 2000,n_iter = 2000)
# #
#
